...
define([
    ...
    var myTable,deptTreeData=[],
            ...
            cZtree.initEditTree('#deptZtree',data,null,null,
                function (event,treeId,treeNode) {
                    ...
                    var treeNode = treeNode,
                        ...
                        editStr = '<span class="" id="diyBtn_add_' +treeNode.id+ '" style="margin:0 0 0 10px;">'+treeNode.number+'</span>';
        ...
        initLevelTree = function (data) {
            cZtree.initEditTree('#levelTree',data,null,null,
                function (event,treeId,treeNode) {
                    vm.searchData.levelTree = treeNode.id;
                    vm.search();
                },function (treeId, treeNode) {
                    var treeNode = treeNode,
                        aObj = $('#' + treeNode.tId + '_span'),
