define([
            ...
            showAddWin: function () {
                ...
                var addModal = $('#adModal').modal('setting', {
                    ...
                    onApprove: function() {
                        ...
                        $.ajax({
                            url: window.currentApiUrl.adManagement.adAdd,
                            type: 'POST',
                            data: formData,
                            async: false,
                            cache: false,
            ...
            showEditWin: function (rowData) {
                ...
                var editModal = $('#adModal').modal('setting', {
                    ...
                    onApprove: function() {
                        ...
                        var formData = new FormData($('#data')[0]);
                        $.ajax({
                            url: window.currentApiUrl.adManagement.adEdit,
                            type: 'POST',
                            data: formData,
                            async: false,
                            cache: false,
            ...
            showDeleteWin: function(id) {
                var deleteModal = $('#confirm').modal('setting', {
                    ...
                    onApprove: function() {
                        var success = true;
                        $.ajax({
                            url: window.currentApiUrl.adManagement.adDelete,
                            type: 'GET',
                            data: 'id=' + id,
                            async: false,
                            cache: false,
    ...
    var baseTableOpts = {
        ...
        ajax: {
            url: window.currentApiUrl.adManagement.adList,
            type: 'GET',
            data: function (data) {
