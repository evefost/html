    ...
    var myTable,myBillModal,sheetTable
        ...
        vm = avalon.define({
            ...
            showInfoWin:function (data) {
                ...
                jqueryAjax.get(
                    window.currentApiUrl.bill.getBill,
                    {id:data.id},
                    function (response) {
            ...
            showDeleteWin: function (id) {
                cMessage.showAlert({
                    ...
                    onOk: function () {
                        jqueryAjax.post(
                            window.currentApiUrl.bill.billDel,
                            {id: id},
            ...
            exportBillExcel:function () {
                cMthods.downloadFile(location.origin+window.currentApiUrl.bill.exportBill,vm.searchFormData);
            },
            downloadTemplateExcel:function () {
                cMthods.downloadFile(location.origin+window.currentApiUrl.bill.downloadTemplateBill,{parkName:vm.parkName,parkId:vm.parkId});
            },
        ...
        baseTableOpts = {
            ...
            ajax: {
                url: window.currentApiUrl.bill.billList,
                type: 'GET',
                data: function (data) {
                    data.pageNo = data.start / data.length + 1;
                    data.pageSize = data.length;
