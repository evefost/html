    ...
    var myTable,
        ...
        defaultFromData = function () {
            return {
                ...
                createTime : '',
                updateTime : '',
                authStatus : '', // 用户状态 1 待审核，2 已审核，3 审核不通过，0 未提交审核
                useStatus: '', // 用户状态 1 已启用，0 已禁用
        ...
        vm = avalon.define({
            ...
            showAuditWin:function(data){
                ...
                if (vm.enterpriseUser.useStatus == '1') {
                    vm.enterpriseUser.useStatus = '已启用';
                } else if (vm.enterpriseUser.useStatus == '0') {
                    vm.enterpriseUser.useStatus = '已禁用';
                }
                ...
                var myApproveModel  = $('#enterpriseUserInfoWin').modal({
                    ...
                    onApprove: function () {
                        ...
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.certificatEdit,
                            {
            ...
            showDisenableWin: function (id) {
                cMessage.showAlert({
                    ...
                    onOk: function () {
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.disenableCertificatUser,
                            {id: id},
                            function (response, msgType, isOk) {
                                myTable.draw();
                                cMessage.showPopup({
            ...
            showEnableWin: function (id) {
                cMessage.showAlert({
                    ...
                    onOk: function () {
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.enableCertificatUser,
                            {id: id},
                            function (response, msgType, isOk) {
                                myTable.draw();
                                cMessage.showPopup({
        ...
        baseTableOpts = {
            ...
            columns: [
                ...
                {field: 'authStatus', title: '审核状态', isShow: true, isSort: false,render: function (data) {
            ...
            ajax: {
                url: window.currentApiUrl.systemSet.appUser.certificatList,
                type: 'GET',
                data: function (data) {
