    ...
    var myTable,
        ...
        vm = avalon.define({
            ...
            showAuditWin:function(data){
                ...
                if (vm.enterpriseUser.userStatus == '1') {
                    vm.enterpriseUser.userStatus = '已启用';
                } else if (vm.enterpriseUser.userStatus == '0') {
                ...
                var myApproveModel  = $('#enterpriseUserInfoWin').modal({
                    ...
                    onApprove: function () {
                        ...
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.appManageEdit,
                            {
            ...
            showDisenableWin: function (id) {
                cMessage.showAlert({
                    ...
                    onOk: function () {
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.disenableAppUser,
                            {id: id},
                            function (response, msgType, isOk) {
                                myTable.draw();
                                cMessage.showPopup({
            ...
            showEnableWin: function (id) {
                cMessage.showAlert({
                    ...
                    onOk: function () {
                        jqueryAjax.post(
                            window.currentApiUrl.systemSet.appUser.enableAppUser,
                            {id: id},
                            function (response, msgType, isOk) {
                                myTable.draw();
                                cMessage.showPopup({
        ...
        baseTableOpts = {
            ...
            columns: [
                ...
                {field: 'authStatus', title: '企业认证状态', isShow: true, isSort: false,render: function (data) {
                ...
                }},
                {
                    ...
                    render: function (data) {
                        var isEnableHtml = data.userStatus == '1' ? '<i class="icon unlock black" title="禁用"></i>' :'<i class="icon lock orange" title="启用"></i>',
            ...
            ajax: {
                url: window.currentApiUrl.systemSet.appUser.appManageList,
                type: 'GET',
                data: function (data) {
