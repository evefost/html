define([
    ...
    var table,
        ...
        vm = avalon.define({
            ...
            back: function () {
                avalon.router.go('app.systemSetting.billSetting');
            },
            ...
            exportBillExcel: function () {
                cMethod.downloadFile(window.currentApiUrl.billTempl.exportBill, {parkId: vm.parkId});
            },
            switchStatus: function (rowData) {
                ...
                $.ajax({
                    url: window.currentApiUrl.billTempl.switchStatus,
                    type: 'GET',
            ...
            showAddWin: function (event) {
                ...
                var addModal = $('#nodeModal').modal('setting', {
                    ...
                    onApprove: function() {
                        ...
                        $.ajax({
                            url: window.currentApiUrl.billTempl.saveNode,
                            type: 'POST',
                            data: formData,
                            async: false,
                            cache: false,
            ...
            moveUp: function (rowData) {
                ...
                $.ajax({
                    url: window.currentApiUrl.billTempl.sortColumn,
                    type: 'GET',
                    data: data,
                    async: false,
                    cache: false,
    ...
    var baseTableOpts = {
        ...
        ajax: {
            url: window.currentApiUrl.billTempl.templDetail,
            type: 'GET',
            data: function (data) {
