define([
    ...
    var table,
        ...
        vm = avalon.define({
            ...
            isEdit: false,
            back: function () {
                avalon.router.go('app.systemSetting.repairSetting');
            },
            ...
            save: function () {
                ...
                $.ajax({
                    url: window.currentApiUrl.repairSetting.saveContent,
                    type: 'POST',
                    data: formData,
                    async: false,
                    cache: false,
            ...
            showAddWin: function (event) {
                ...
                var editModal = $('#serviceModal').modal('setting', {
                    ...
                    onApprove: function() {
                        ...
                        $.ajax({
                            url: window.currentApiUrl.repairSetting.saveService,
                            type: 'POST',
                            data: formData,
                            async: false,
                            cache: false,
            ...
            switchStatus: function (rowData) {
                ...
                $.ajax({
                    url: window.currentApiUrl.repairSetting.startOrStop,
                    type: 'GET',
    ...
    var baseTableOpts = {
        ...
        columns: [
            ...
            {field: 'supportType', title: '服务提供方', isShow: true, isSort: false, render: function(val) {
                if (val == 'PARK') {
                    return '园区物业';
        ...
        ajax: {
            url: window.currentApiUrl.repairSetting.serviceList,
            type: 'GET',
            data: function (data) {
    ...
    return avalon.controller(function ($ctrl) {
        ...
        $ctrl.$onRendered = function () {
            ...
            // 获取初始数据
            $.ajax({
                url: window.currentApiUrl.repairSetting.repairDetail,
                type: 'GET',
                data: 'parkId=' + vm.queryData.parkId,
                async: false,
                cache: false,
                contentType: false,
                processData: false,
